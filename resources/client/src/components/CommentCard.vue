    ...
    <v-card-text class="pa-0">
      <div class="d-flex justify-start mb-4">
        ...
        <div class="comment-wrapper ml-3">
          ...
          <v-btn
            v-if="undefined !== post.reply || undefined !== post.sub_reply"
            class="ma-1"
            text
            small
          ...
          <div v-if="showReplyForm">
            ...
            ></v-textarea>
            <v-btn class="ma-1" @click="sendReply(post)" color="primary"
              >Send</v-btn
            >
          </div>
          <div v-if="undefined !== post.reply && post.reply.length > 0">
            <ComponentCard
          ...
          <div v-if="undefined !== post.sub_reply && post.sub_reply.length > 0">
            <ComponentCard
